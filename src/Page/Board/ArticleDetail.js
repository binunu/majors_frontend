            ...
            <div className='title-box'>
              ...
              <div className='t-sub-box'>
                <div className='t-sub-box-1'>
                  <div className='img'><img src={`http://localhost:8080/image/view/${article.writer.profile}`} alt='' /></div>
            ...
            <div className='response-box'>
              ...
              <button className={`response bad ${onBad ? 'on' : ''}`} value='F' onClick={stamp}>👎 {article.bads}</button>
              {
                ...
                <div className='edit-box'>
                  <Link to={`/modify/${id}`} className='edit-btn'>수정</Link>&nbsp;&nbsp;<button className='edit-btn' onClick={() => { delAction('write', id) }}>삭제</button>
                </div>
              }
            </div>
